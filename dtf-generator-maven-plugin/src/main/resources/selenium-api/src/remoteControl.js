...
function formatCommand(command) {
	...
	if (command.type == 'command') {
		...
		} else if (command.command.match(/^(onload)\w*$/)) {
			// Generates a lines for an onload function
			line = onload(command);
		} else if (def) {
	...
	/*
	 * Aqui se agregaron mas lineas para generar en la clase Java.
	 * Con estos agregados se mejoran los mensajes de excepcion lanzados cuando falla una prueba.
	 */ 
