...
function Command(command, target, value) {
	Command(command, target, value, false, false);
}

function Command(command, target, value, errorStep) {
	Command(command, target, value, errorStep, false);
}

function Command(command, target, value, errorStep, testingCommand) {
	...
	this.errorStep = errorStep != null ? errorStep : false;
	this.testingCommand = testingCommand != null ? testingCommand : false;
}
