...
//
package com.dextratech.dtf.plugin.utils;
...
public class VelocityUtils {
	 ...
	 */
	public static void evaluate(Map<String, Object> vParams, String templatePath, String outputDir, String fileName) throws URISyntaxException, IOException {
