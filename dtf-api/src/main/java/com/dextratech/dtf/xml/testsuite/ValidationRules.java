    ...
    implements ToString
{
    ...
    protected List<ValidationFunction> function;
     ...
     * 
     */
    public List<ValidationFunction> getFunction() {
        if (function == null) {
            function = new ArrayList<ValidationFunction>();
        }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<ValidationFunction> theFunction;
